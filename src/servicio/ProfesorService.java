...
public class ProfesorService {
  ...
  protected void insert(String profesorID, String cedula, String nombre, String titulo, String area, String telefono) {
     ProfesorDTO prof = new ProfesorDTO();
  ...
  protected void update(String profesorID, String cedula, String nombre, String titulo, String area, String telefono) {
